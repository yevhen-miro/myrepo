...
public class PerformanceInterceptor {
	...
	@AroundInvoke // intercepter invocation
	public Object intercept(InvocationContext context) throws Exception { // intercepter definition
		...
		logService.logMessage("execution of " + context.getMethod().getName() + " took "+(endTime - startTime)+" ms.");
		return returnValue;
	}
