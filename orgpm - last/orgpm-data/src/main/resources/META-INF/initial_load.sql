...
insert into BUCHUNGEN (id,aktivitaet, anfang, datum, ende, minuten, pause_bis, pause_von, projekt, stunden,taetigkeiten,wartung_id,mitarbeiter) VALUES (4,2,sysdate,sysdate,sysdate,20,sysdate, sysdate,1,3,'Materialized View for DM_PRODUCTION',1,1);
insert into BUCHUNGEN (id,aktivitaet, anfang, datum, ende, minuten, pause_bis, pause_von, projekt, stunden,taetigkeiten,wartung_id,mitarbeiter) VALUES (5,1,sysdate,sysdate,sysdate,20,sysdate, sysdate,1,3,'Trigger-korrketur',1,1);
insert into BUCHUNGEN (id,aktivitaet, anfang, datum, ende, minuten, pause_bis, pause_von, projekt, stunden,taetigkeiten,wartung_id,mitarbeiter) VALUES (6,1,sysdate,sysdate,sysdate,20,sysdate, sysdate,2,3,'Rheinwerk',1,1);
insert into BUCHUNGEN (id,aktivitaet, anfang, datum, ende, minuten, pause_bis, pause_von, projekt, stunden,taetigkeiten,wartung_id,mitarbeiter) VALUES (7,1,sysdate,sysdate,sysdate,20,sysdate, sysdate,2,3,'LOGI-Schnittstelle',1,1);
insert into BUCHUNGEN (id,aktivitaet, anfang, datum, ende, minuten, pause_bis, pause_von, projekt, stunden,taetigkeiten,wartung_id,mitarbeiter) VALUES (8,1,sysdate,sysdate,sysdate,20,sysdate, sysdate,2,3,'F3LS-DAO',1,1);
insert into BUCHUNGEN (id,aktivitaet, anfang, datum, ende, minuten, pause_bis, pause_von, projekt, stunden,taetigkeiten,wartung_id,mitarbeiter) VALUES (9,1,sysdate,sysdate,sysdate,20,sysdate, sysdate,2,3,'Junit-test',1,1);
