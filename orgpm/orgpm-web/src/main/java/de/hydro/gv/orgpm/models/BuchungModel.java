...
//		this.setAktivitaet( this.entity.getAktivitaet() );
...
//		this.setProjekt( this.entity.getProjekt() );
...
//		this.entity.setAktivitaet( this.getAktivitaet() != null ? this.getAktivitaet() : null );
