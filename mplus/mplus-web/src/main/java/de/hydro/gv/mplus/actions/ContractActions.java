...
@ViewScoped
@ManagedBean
public class ContractActions implements Serializable {

	private static final long serialVersionUID = 2279216426451381465L;
	private static final String destination = "E:\\Buffer\\";
	private static final Logger logger = Logger.getLogger(ContractActions.class);
	...
	public void init() throws Exception {
		...
		if (contractId != null && !contractId.equals("") && !this.loaded) {
			try {
				...
				Long durationInfo = (endInfoTime - startInfoTime); // divide by 1000000 to get
				// milliseconds.
	...
	public String createNewContract() throws Exception {
		this.actContract.setCreatedby(userService.findUserByHydroId(securityActions.getSecurityPrincipalForLoggedInUser()));
		this.actContract.setCustomer(this.customer);
		this.actContract.setCbu(this.cbu);
